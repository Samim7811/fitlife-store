...
export default function Home() {
    ...
    <main className="page">
      <style jsx global>{`
        *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;font-family:Arial,Helvetica,sans-serif;background:#fff;color:#080808}
        ...
        .howLongImage{width:min(900px,100%);margin:30px auto 0;background:#fff;border-radius:22px;overflow:hidden;border:1px solid #ddd;box-shadow:0 5px 20px #ddd}
        .howLongImage img{width:100%;height:auto;display:block}
  ...
  <p className="lead">5 essential fitness products in one complete kit.</p>
...
<section className="section">
        ...
        <h2>TRAIN. IMPROVE. REPEAT.</h2>

        <div className="resultLongImage">
          <img
            src="/images/results-long.png"
            alt="FitLife fitness results"
          />
        </div>
      </section>
